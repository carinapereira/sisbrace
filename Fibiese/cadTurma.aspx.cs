    ...
    public partial class cadTurma : System.Web.UI.Page
    {
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (turmas.Id > 0)
            {
                ...
                {
                    lblMensagem.Text = "Turma atualizada com sucesso !";
                    txtDescricao.Focus();
                }
                else
                    lblMensagem.Text = "Não foi possível atualizar a turma. Revise as informações.";
            ...
            else
            {
                ...
                if (id_turma > 0)
                {
                    lblMensagem.Text = "Turma gravada com sucesso !";
                    btnParticipantes.Visible = true;
                    txtDescricao.Focus();
                }
                else
                    lblMensagem.Text = "Não foi possível gravar a turma. Revise as informações.";
            }
        }
