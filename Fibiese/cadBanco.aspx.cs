        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (bancos.Id > 0)
            {
                ...
                if (banBL.EditarBL(bancos))
                    lblMensagem.Text = "Banco atualizado com sucesso !";
                else
                    lblMensagem.Text = "Não foi possível atualizar o banco. Revise as informações.";
            ...
            else
            {
                ...
                {
                    lblMensagem.Text = "Banco gravado com sucesso !";
                    LimparCampos();
                    txtCodigo.Focus();
                }
                else
                    lblMensagem.Text = "Não foi possível gravar o banco. Revise as informações.";
            }
        }
