    ...
    public partial class viewTurma : System.Web.UI.Page
    {
        ...
        private void Pesquisar(string valor)
        {
            ...
            foreach (Turmas tur in turmas)
            {
                ...
                linha["DTINICIAL"] = tur.DataInicial.ToString() == string.Empty ? "" : string.Format("{0:dd/MM/yyyy}", (DateTime)tur.DataInicial);
                linha["DTFINAL"] = tur.DataFinal.ToString() == string.Empty ? "" : string.Format("{0:dd/MM/yyyy}", (DateTime)tur.DataFinal); 
