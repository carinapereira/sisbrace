...
namespace Admin
{
    public partial class cadAgencia : System.Web.UI.Page
    {
        ...
        private void CarregarDdlCidade(DropDownList ddl, string id_uf)
        {
        ...
        private void carregarDados(int id_age)
        {
            ...
            foreach (Agencias ltAge in age)
            {
                ...
                {
                    ddlUF.SelectedValue = ltAge.Cidade.UF;
                    CarregarDdlCidade(ddlCidades, ltAge.Cidade.UF);
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (agencias.Id > 0)
            {
                ...
                if (ageBL.EditarBL(agencias))
                    lblMensagem.Text = "Agência atualizada com sucesso !";
                else
                    lblMensagem.Text = "Não foi possível atualizar a agência. Revise as informações.";
            ...
            else
            {
                ...
                {
                    lblMensagem.Text = "Agência gravada com sucesso !";
                    LimparCampos();
                    txtCodigo.Focus();
                }
                else
                    lblMensagem.Text ="Não foi possível gravar a agência. Revise as informações.";
