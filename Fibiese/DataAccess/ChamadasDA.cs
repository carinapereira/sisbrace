...
namespace DataAccess
{
    public class ChamadasDA
    {
        ...
        public DataSet PesquisarDataSetDA(string data, int turmaId, string alunosCod, int preenchido, string diasSemanas)
        {
            ...
            if (data != string.Empty)
                periodo = Convert.ToDateTime(data);

            paramsToSP[0] = new SqlParameter("@MES", periodo.ToString("MM"));//string
            paramsToSP[1] = new SqlParameter("@ANO", periodo.ToString("yyyy"));//string
