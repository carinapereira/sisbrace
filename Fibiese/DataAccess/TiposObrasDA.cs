...
namespace DataAccess
{
    public class TiposObrasDA : BaseDA
    {
        ...
        public bool InserirDA(TiposObras instancia)
        {
            ...
            query.Append(@" insert into tiposobras(codigo, descricao, qtddias)");
            query.Append(@" values(@codigo, @descricao, @qtddias)");
        ...
        public bool EditarDA(TiposObras instancia)
        {
            ...
            query.Append(@" update tiposobras set codigo=@codigo, descricao=@descricao, qtddias=@qtddias");
        ...
        public bool ExcluirDA(TiposObras instancia)
        {
            try
            {
                SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["conexao"].ToString(), CommandType.Text,
                                          string.Format("DELETE FROM tiposobras WHERE id = {0}", instancia.Id));    
                return true;
            }
            catch (Exception e)
            {
