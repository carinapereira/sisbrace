...
namespace DataAccess
{
    public class BairrosDA : BaseDA
    {
        ...
        public bool InserirDA(Bairros bai)
        {
            ...
            query.Append(@"insert into bairros(codigo, descricao, cidadeid) ");
            query.Append(@"values(@codigo, @descricao, @cidadeid)");
        ...
        public bool EditarDA(Bairros bai)
        {
            ...
            query.Append(@"update bairros set codigo=@codigo, descricao=@descricao, cidadeid=@cidadeid ");
        ...
        {            
            ...
            {
                SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["conexao"].ToString(), CommandType.Text,
                                          string.Format("DELETE FROM bairros WHERE id = {0}", bai.Id));    
        ...
        public List<Bairros> PesquisarDA()
        {
            ...
            consulta.Append(@"SELECT B.*, C.CODIGO CODCID, C.DESCRICAO DESCID, C.UF ");
        ...
        public List<Bairros> PesquisarCidDA(int id_cid)
        {
            ...
            consulta.Append(@"  FROM BAIRROS B");
            consulta.Append(@"      ,CIDADES C");
            consulta.Append(@" WHERE B.CIDADEID ={0}");
        ...
        public List<Bairros> PesquisarBuscaDA(string valor)
        {
            ...
            if (valor != "" && valor != null)
            {
                ...
                consulta.Append(@"   OR B.DESCRICAO LIKE '%{1}%')");
            }
