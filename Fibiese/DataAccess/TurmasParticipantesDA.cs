...
namespace DataAccess
{
    public class TurmasParticipantesDA
    {
        ...
        public bool InserirDA(TurmasParticipantes turP)
        {
            ...
            query.Append(@" insert into turmasparticipantes(pessoaid, turmasid)");
            query.Append(@" values(@pessoaid, @turmasid)");
        ...
        public bool EditarDA(TurmasParticipantes turP)
        {
            ...
            query.Append(@" update turmasparticipantes set pessoaid=@pessoaid, turmasid=@turmasid)");
        ...
        {       
            try
            {
                SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["conexao"].ToString(), CommandType.Text,
                                          string.Format("DELETE FROM turmasparticipantes WHERE id = {0}", turP.Id));    
