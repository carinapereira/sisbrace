...
namespace DataAccess
{
    public class BancosInstrucoesDA : BaseDA
    {
        ...
        public bool InserirDA(BancosInstrucoes ban)
        {
            ...
            query.Append(@" insert into bancosinstrucoes(codigo, descricao, nrdias, bancoid)");
            query.Append(@" values(@codigo, @descricao, @nrdias, @bancoid);");
        ...
        public bool EditarDA(BancosInstrucoes ban)
        {
            ...
            query.Append(@" update bancosinstrucoes set codigo=@codigo, descricao=@descricao, nrdias=@nrdias, bancoid=@bancoid");
        ...
        public bool ExcluirDA(BancosInstrucoes ban)
        {
            try
            {
                SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["conexao"].ToString(), CommandType.Text,
                                           string.Format("DELETE FROM bancosinstrucoes WHERE id = {0}", ban.Id));    
