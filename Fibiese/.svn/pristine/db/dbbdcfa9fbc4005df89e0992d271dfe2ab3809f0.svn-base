    ...
    public partial class cadInstituicao : System.Web.UI.Page
    {
        ...
        private void CarregarDados(int id_ins)
        {
            ...
            foreach (Instituicoes ltIns in intituicoes)
            {
                ...
                {
                    ddlUF.SelectedValue = ltIns.Cidades.UF;
                    CarregarDdlCidade(ddlCidades, ltIns.Cidades.UF);
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (instituicoes.Id > 0)
                {
                    ...
                    {
                        VerificarImagem();
                        lblMensagem.Text = "Instituição atualizada com sucesso !";
                    }
                    else
                        lblMensagem.Text = "Não foi possível atualizar a instituição. Revise as informações.";
                ...
                else
                {
                    ...
                    {
                        VerificarImagem();
                        lblMensagem.Text = "Instituição gravada com sucesso !";
                        LimparCampos();
                    }
