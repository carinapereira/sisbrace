...
namespace Admin
{
    public partial class viewUsuario : System.Web.UI.Page
    {
        ...
        private void Pesquisar(string valor)
        {
            ...
            DataColumn coluna3 = new DataColumn("EMAIL", Type.GetType("System.String"));
            DataColumn coluna4 = new DataColumn("STATUS", Type.GetType("System.String"));
            DataColumn coluna5 = new DataColumn("CODCAT", Type.GetType("System.Int32"));
            DataColumn coluna6 = new DataColumn("DESCAT", Type.GetType("System.String"));
