    ...
    public partial class cadTipoDocumento : System.Web.UI.Page
    {
        ...
        protected void btnInserir_Click(object sender, EventArgs e)
        {
            ...
            if (tiposDocumentos.Id > 0)
            {
                ...
                {
                    lblMensagem.Text = "Tipo de documento atualizado com sucesso !";
                    txtDescricao.Focus();
                }
                else
                    lblMensagem.Text = "Não foi possível atualizar o tipo de documento. Revise as informações.";
            }
            else
            {
                if (tdoBL.InserirBL(tiposDocumentos))
                {
                    lblMensagem.Text = "Tipo de documento gravado com sucesso !";
                    LimparCampos();
                    txtDescricao.Focus();
                }
                else
                    lblMensagem.Text  = "Não foi possível gravar o tipo de documento. Revise as informações.";
