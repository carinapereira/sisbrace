...
namespace DataAccess
{
    public class UsuariosDA
    {
        ...
        public bool InserirDA(Usuarios usu)
        {
            ...
            paramsToSP[4] = new SqlParameter("@email", usu.Email);
            paramsToSP[5] = new SqlParameter("@nrtentlogin", usu.NrTentLogin == null ? (object)DBNull.Value : usu.NrTentLogin);
            paramsToSP[6] = new SqlParameter("@dhtentlogin", usu.DhTentLogin == null ? (object)DBNull.Value : usu.DhTentLogin);
            paramsToSP[7] = new SqlParameter("@categoriaid", usu.CategoriaId);
            
            query.Append(@"	insert into usuarios(Login,senha,Nome,Status,Email,nrTentLogin,dhTentLogin,categoriaid)");
	        query.Append(@" values(@login,@senha,@nome,@status,@email,@nrtentlogin,@dhtentlogin,@categoriaid)"); 
        ...
        public bool EditarDA(Usuarios usu)
        {
            ...
            paramsToSP[6] = new SqlParameter("@nrtentlogin", usu.NrTentLogin == null ? (object)DBNull.Value : usu.NrTentLogin);
            paramsToSP[7] = new SqlParameter("@dhtentlogin", usu.DhTentLogin == null ? (object)DBNull.Value : usu.DhTentLogin);
            paramsToSP[8] = new SqlParameter("@categoriaid", usu.CategoriaId);
            
            query.Append(@" update usuarios set Login=@login, senha=@senha, Nome=@nome, Status=@status");
		    query.Append(@" , Email=@email, nrTentLogin=@nrtentlogin, dhTentLogin=@dhtentlogin,categoriaid=@categoriaid");
        ...
        public bool ExcluirDA(Usuarios usu)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(ConfigurationManager.ConnectionStrings["conexao"].ToString(), CommandType.Text,
                                          string.Format("DELETE FROM usuarios WHERE id = {0}", usu.Id));    
