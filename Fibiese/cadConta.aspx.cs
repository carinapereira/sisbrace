        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (contas.Id > 0)
            {
                ...
                if (conBL.EditarBL(contas))
                    ...
                    lblMensagem.Text = "Não foi possível atualizar a conta. Revise as informações.";
            ...
            else
            {
                ...
                {
                    lblMensagem.Text = "Conta gravada com sucesso !";
                    LimparCampos();
                    ddlBanco.Focus();
                }
                else
                    lblMensagem.Text = "Não foi possível gravar a conta. Revise as informações.";
            }
        }
