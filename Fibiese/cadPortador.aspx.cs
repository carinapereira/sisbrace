        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (portadores.Id > 0)
            {
                ...
                if (porBL.EditarBL(portadores))
                    lblMensagem.Text = "Portador atualizado com sucesso !";
                else
                    lblMensagem.Text = "Não foi possível gravar o portador. Revise as informações.";
            ...
            else
            {
                ...
                {
                    lblMensagem.Text = "Portador gravado com sucesso !";
                    LimparCampos();
                }
                else
                    lblMensagem.Text = "Não foi possível gravar o portador. Revise as informações.";
