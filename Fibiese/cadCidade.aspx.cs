...
namespace Admin
{
    public partial class cadCidade : System.Web.UI.Page
    {
        ...
        {          
            ddlEstado.DataSource = System.Enum.GetNames(typeof(Estado));
            ddlEstado.DataBind();
            ddlEstado.SelectedIndex = 20;
        }
        ...
        private void CarregarDados(int id_cid)
        {
            ...
            if (dsCid.Tables[0].Rows.Count != 0)
            {
                ...
                ddlEstado.SelectedValue = (string)dsCid.Tables[0].Rows[0]["uf"].ToString();
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            cidades.UF = ddlEstado.SelectedValue.ToString();
