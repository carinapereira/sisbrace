    ...
    public partial class cadCurso : System.Web.UI.Page
    {
        ...
        protected void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            if (eventos.Id > 0)
            {
                ...
                {
                    lblMensagem.Text="Evento atualizado com sucesso !";
                    txtDescricao.Focus();
                }
                else
                    lblMensagem.Text= "Não foi possível atualizar o evento. Revise as informações.";
            ...
            else
            {
                ...
                {
                    lblMensagem.Text = "Evento gravado com sucesso !";
                    LimparCampos();
                    txtDescricao.Focus();
                }
                else
                    lblMensagem.Text = "Não foi possível gravar o evento. Revise as informações.";
