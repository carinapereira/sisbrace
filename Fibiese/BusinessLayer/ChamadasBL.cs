...
namespace BusinessLayer
{
    public class ChamadasBL
    {
        ...
        public DataSet PesquisarDataSet(string data, int turmaId, string alunosCod, int preenchido, string diasSemanas)
        {
            ChamadasDA chaDA = new ChamadasDA();

            return chaDA.PesquisarDataSetDA(data, turmaId, alunosCod, preenchido, diasSemanas);
        }
